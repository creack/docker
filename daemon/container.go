...
func (container *Container) startLoggingToDisk() error {
	...
	if err := container.daemon.LogToDisk(container.stdout[0], container.logPath("json"), "stdout"); err != nil {
		return err
	}
	if err := container.daemon.LogToDisk(container.stderr[0], container.logPath("json"), "stderr"); err != nil {
		return err
	}
	return nil
}
